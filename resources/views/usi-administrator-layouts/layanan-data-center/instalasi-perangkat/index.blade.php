...
<div class="breadcrumb">
    <h1>Tabel Co-Location Perangkat</h1>
    {{-- <ul>
...
<script>
    ...
    $(document).ready(function () {
        $('#zero_configuration_device_installation').DataTable({
            ...
            processing:true,
            serverSide: true,
            ajax: '/staff/layanan/deviceinstallationjson',
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        ...
                        const detailUrl = "{{ route('staff.layanan.instalasi-perangkat.show', ':device_installation_registration_id') }}".replace(':device_installation_registration_id', data.device_installation_registration_id);
...
<script>
    $(document).ready(function() {
        $('#btn-add-new').click(function() {
            window.location.href = '/staff/layanan/instalasi-perangkat/create';
        });
    });
</script>
