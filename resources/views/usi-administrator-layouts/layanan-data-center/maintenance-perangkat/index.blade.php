...
<div class="breadcrumb">
    <h1>Tabel Pemeliharaan Perangkat</h1>
    <ul>
...
<script>
    ...
    $(document).ready(function () {
        $('#zero_configuration_device_maintenance').DataTable({
            ...
            processing:true,
            serverSide: true,
            ajax: '/staff/layanan/devicemaintenancejson',
            columns: [
                { data: 'id', name: 'device_maintenances.id', visible:false },
                { data: 'device_maintenance_registration_id', name: 'device_maintenance_registration_id',  visible:false },
                ...
                {
                    data: 'device_maintenance_acceptance_status', 
                    name: 'device_maintenance_acceptance_status',
                ...
                },
                {
                    ...
                    render: function (data) {
                        ...
                        const detailUrl = "{{ route('staff.layanan.pemeliharaan-perangkat.show', ':device_maintenance_registration_id') }}".replace(':device_maintenance_registration_id', data.device_maintenance_registration_id);
...
<script>
    $(document).ready(function() {
        $('#btn-add-new').click(function() {
            window.location.href = '/staff/layanan/pemeliharaan-perangkat/create';
        });
    });
</script>
