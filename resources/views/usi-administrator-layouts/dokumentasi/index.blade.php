            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <a href="{{ route('staff.dokumentasi.user-manual') }}">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    <i class="i-Data"></i>
                                    <p class="text-muted mt-2 mb-2">User Manual</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <a href="{{ route('staff.dokumentasi.maps') }}">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    <i class="i-Internet"></i>
                                    <p class="text-muted mt-2 mb-2">Maps</p>
                                    <p class="text-primary text-24 line-height-1 m-0"></p>
                                </div>
                            </div>
                        </a>
