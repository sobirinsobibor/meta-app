    ...
    <div class="card text-left">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="zero_configuration_mapping_wifi" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th>id</th>
...
<div class="modal fade  bd-example-modal-lg" id="exampleModalCenter_new" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle-2" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('staff.pendataan.mapping-wifi') }}" enctype="multipart/form-data" id="item-form">
                    @csrf
                        <div class="form-row ">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">     
                                ...
                                <div class="form-group col-md-12">
                                    <label for="wifi_mapping_description" class="ul-form__label">Keterangan</label>
                                    <textarea class="form-control" id="wifi_mapping_description" rows="5" name="wifi_mapping_description"></textarea>
...
<script>
    ...
    $(document).ready(function () {
        $('#zero_configuration_mapping_wifi').DataTable({
            dom: 'Bfrtip',
            buttons: [
                {
                    text:'+ Add New',
            ...
            processing:true,
            serverSide: true,
            ajax: '/staff/pendataan/mappingwifijson',
            columns: [
...
<script>
    var textarea = document.getElementById('wifi_mapping_description');
