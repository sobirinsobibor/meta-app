    ...
    <div class="card text-left">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="zero_configuration_topologi_jaringan_detail" class="display table table-striped table-bordered" style="width:100%">
...
<script>
    ...
    $(document).ready(function () {
        $('#zero_configuration_topologi_jaringan_detail').DataTable({
