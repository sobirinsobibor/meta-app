    ...
    <div class="card text-left">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="zero_configuration_device_dismantle" class="display table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th>id</th>
...
<script>
    ...
    $(document).ready(function () {
        $('#zero_configuration_device_dismantle').DataTable({
            
            processing:true,
            serverSide: true,
            ajax: '/admin/layanan/devicedismantlejson',
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        ...
                        const detailUrl = "{{ route('admin.layanan.pelepasan-perangkat.show', ':device_dismantle_registration_id') }}".replace(':device_dismantle_registration_id', data.device_dismantle_registration_id);
