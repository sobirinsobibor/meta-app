...
<script>
    ...
    $(document).ready(function () {
        $('#zero_configuration_device_maintenance').DataTable({
            ...
            processing:true,
            serverSide: true,
            ajax: '/admin/layanan/devicemaintenancejson',
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        ...
                        const detailUrl = "{{ route('admin.layanan.pemeliharaan-perangkat.show', ':device_maintenance_registration_id') }}".replace(':device_maintenance_registration_id', data.device_maintenance_registration_id);
